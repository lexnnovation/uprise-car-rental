    ...
    public function run(): void
    {
        ...
        $vehicles = [
            [
                ...
                'hero_image_url' => '/images/fleet/mercedes-s-class.jpg',
                'gallery_images' => ['/images/fleet/mercedes-s-class.jpg', '/images/fleet/salon.jpg', '/images/fleet/mercedes-e-class.jpg'],
                'passenger_count' => 3,
                'luggage_count' => 2,
                'is_featured' => true,
                'sort_order' => 1,
                'meta_title' => 'Mercedes-Benz S-Class Car Rental with Driver | Executive Airport Transfer Accra',
            ...
            [
                ...
                'hero_image_url' => '/images/fleet/mercedes-e-class.jpg',
                'gallery_images' => ['/images/fleet/mercedes-e-class.jpg', '/images/fleet/mercedes-s-class.jpg', '/images/fleet/salon.jpg'],
                'passenger_count' => 3,
                'luggage_count' => 2,
                'is_featured' => true,
                'sort_order' => 2,
                'meta_title' => 'Mercedes-Benz E-Class Car Rental with Driver Accra | Corporate Transfer Ghana',
            ...
            [
                ...
                'hero_image_url' => '/images/fleet/bmw-5-series.jpg',
                'gallery_images' => ['/images/fleet/bmw-5-series.jpg', '/images/fleet/salon.jpg', '/images/fleet/mercedes-s-class.jpg'],
                'passenger_count' => 3,
                'luggage_count' => 2,
                'is_featured' => false,
                'sort_order' => 3,
                'meta_title' => 'BMW 5 Series Car Rental with Driver Ghana | Executive Car Hire Accra',
            ...
            [
                ...
                'hero_image_url' => '/images/fleet/range-rover-sport.jpg',
                'gallery_images' => ['/images/fleet/range-rover-sport.jpg', '/images/fleet/lexus-lx.jpg', '/images/fleet/highlander.jpg'],
                'passenger_count' => 4,
                'luggage_count' => 3,
                'is_featured' => true,
                'sort_order' => 4,
                'meta_title' => 'Range Rover Sport Car Rental with Driver Ghana | Executive SUV Hire Accra',
                'meta_description' => 'Chauffeur-driven Range Rover Sport in Ghana. VIP executive transport, airport transfer and upcountry travel. Book your executive SUV today.',
                'published_at' => now(),
            ...
            [
                ...
                'hero_image_url' => '/images/fleet/lexus-lx.jpg',
                'gallery_images' => ['/images/fleet/lexus-lx.jpg', '/images/fleet/highlander.jpg', '/images/fleet/range-rover-sport.jpg'],
                'passenger_count' => 7,
                'luggage_count' => 4,
                'is_featured' => false,
                'sort_order' => 5,
                'meta_title' => 'Lexus LX Car Rental with Driver Ghana | 7-Seat Executive SUV Hire',
                'meta_description' => 'Chauffeur-driven Lexus LX in Ghana. 7-seater premium SUV for family groups, executives and VIP transport. Available 24/7.',
                'published_at' => now(),
                'features' => ['air-conditioning', 'wifi', 'leather-seats', 'complimentary-water', 'phone-charger', 'professional-driver', '24-7-availability'],
            ],
            [
                ...
                'short_description' => 'Premium MPV for groups of up to 7. Facing seats, panoramic roof and business-class cabin refinement.',
                ...
                'hero_image_url' => '/images/fleet/mercedes-v-class.jpg',
                'gallery_images' => ['/images/fleet/mercedes-v-class.jpg', '/images/fleet/minibus.jpg', '/images/fleet/toyota-hiace.jpg'],
                'passenger_count' => 7,
                'luggage_count' => 6,
                'is_featured' => true,
                'sort_order' => 6,
                'meta_title' => 'Mercedes V-Class Hire Ghana | Premium Minivan Accra',
                'meta_description' => 'Chauffeur-driven Mercedes-Benz V-Class in Ghana. 7-seat premium people carrier for groups, airport transfers and corporate travel.',
                'published_at' => now(),
            ...
            [
                ...
                'hero_image_url' => '/images/fleet/toyota-land-cruiser.jpg',
                'gallery_images' => ['/images/fleet/toyota-land-cruiser.jpg', '/images/fleet/landcruiser.jpg', '/images/fleet/toyota-fortuner.jpg'],
                'passenger_count' => 7,
                'luggage_count' => 5,
                'is_featured' => true,
                'sort_order' => 7,
            ...
            [
                ...
                'hero_image_url' => '/images/fleet/toyota-fortuner.jpg',
                'gallery_images' => ['/images/fleet/toyota-fortuner.jpg', '/images/fleet/highlander.jpg', '/images/fleet/toyota-land-cruiser.jpg'],
                'passenger_count' => 6,
                'luggage_count' => 4,
                'is_featured' => false,
                'sort_order' => 8,
            ...
            [
                ...
                'hero_image_url' => '/images/fleet/toyota-hiace.jpg',
                'gallery_images' => ['/images/fleet/toyota-hiace.jpg', '/images/fleet/minibus.jpg', '/images/fleet/mercedes-v-class.jpg'],
                'passenger_count' => 12,
                'luggage_count' => 8,
                'is_featured' => false,
                'sort_order' => 9,
            ...
            [
                ...
                'hero_image_url' => '/images/fleet/toyota-coaster.jpg',
                'gallery_images' => ['/images/fleet/toyota-coaster.jpg', '/images/fleet/minibus.jpg', '/images/fleet/toyota-hiace.jpg'],
                'passenger_count' => 30,
                'luggage_count' => 20,
                'is_featured' => false,
                'sort_order' => 10,
