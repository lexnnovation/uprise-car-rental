...
@php
    ...
    $metaDescription = 'Get in touch with Uprise Travel to book a car with driver in Ghana or West Africa.';
@endphp
...
@section('content')
    ...
    <section class="bg-ink-deep border-b border-charcoal-soft">
        <div class="container-page py-14 lg:py-20">
            ...
            <h1 class="font-display font-bold text-white tracking-tight mb-4 text-[2rem] sm:text-[2.75rem] lg:text-[3.25rem]">
                ...
                <div class="lg:col-span-2">
                    ...
                    @if ($success)
                        <div class="mb-8 flex items-start gap-4 bg-accent/10 border border-accent/30 rounded-md p-5">
                            ...
                            <div>
                                ...
                                <p class="text-stone text-sm">We'll be in touch within a few hours. For faster response, message us on WhatsApp.</p>
                            </div>
                        </div>
                    @endif
                    ...
                    <form action="{{ route('contact.store') }}" method="POST" class="space-y-6" novalidate>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                            ...
                            <div>
                                <label for="passenger_count" class="block text-xs font-semibold text-ink tracking-wide mb-1.5">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                            <div>
                                <label for="pickup_location" class="block text-xs font-semibold text-ink tracking-wide mb-1.5">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                            <div>
                                <label for="travel_date_start" class="block text-xs font-semibold text-ink tracking-wide mb-1.5">
                            ...
                            <div>
                                <label for="travel_date_end" class="block text-xs font-semibold text-ink tracking-wide mb-1.5">
                                    Return / End Date
                                </label>
                ...
                <div class="lg:col-span-1">
                    <div class="sticky top-28 space-y-5">
                        ...
                        <div class="bg-ink rounded-md p-6">
                            ...
                            <p class="text-white font-semibold text-sm mb-4">Message us directly on WhatsApp for same-day confirmation.</p>
                        ...
                        <div class="bg-white rounded-md p-5 shadow-card space-y-4">
                            ...
                            <div class="flex items-start gap-3 text-sm">
                                <svg class="w-4 h-4 text-accent shrink-0 mt-0.5" fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z"/>
                                </svg>
                                <div>
                                    <a href="tel:{{ config('uprise.contact.phone_e164') }}" class="block text-ink hover:text-accent transition-colors font-medium">
                            ...
                            <div class="flex items-start gap-3 text-sm">
                                ...
                                <div>
                                    <a href="tel:+18886462266" class="block text-ink hover:text-accent transition-colors font-medium">
                            ...
                            <div class="flex items-start gap-3 text-sm">
                                ...
                                <a href="mailto:{{ config('uprise.contact.email') }}" class="text-ink hover:text-accent transition-colors font-medium">
                            ...
                            <div class="flex items-start gap-3 text-sm pt-2 border-t border-mist-soft">
                                ...
                                <div class="text-stone">
                                    ...
                                    <p>{{ config('uprise.contact.address.city') }}, {{ config('uprise.contact.address.country') }}</p>
                                </div>
                            </div>
                        </div>
