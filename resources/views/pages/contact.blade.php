            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-start">
                ...
                <div class="bg-ink rounded-md p-8 lg:p-10" data-reveal="fade-left">
                    ...
                    <a href="{{ 'https://wa.me/' . config('uprise.whatsapp.number') . '?text=' . urlencode(config('uprise.whatsapp.default_message')) }}"
                        ...
                        class="btn-shimmer inline-flex items-center justify-center gap-2.5 bg-white text-ink font-semibold
                              text-sm px-7 py-3.5 rounded-lg hover:bg-ink hover:text-white transition-colors duration-150 tracking-wide">
