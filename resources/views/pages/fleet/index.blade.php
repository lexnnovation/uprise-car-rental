                        ...
                        <article class="group bg-white rounded-md overflow-hidden shadow-card hover:shadow-card-hover
                            ...
                            <div class="p-5 flex flex-col flex-1">
                                ...
                                <a href="{{ $enquireUrl }}" target="_blank" rel="noopener"
                                    class="btn-shimmer inline-flex items-center justify-center gap-2 bg-accent text-white text-xs font-semibold
                                           px-4 py-2.5 rounded-lg hover:bg-accent-deep transition-colors duration-150 tracking-wide">
    ...
    <section class="bg-accent py-10">
        <div class="container-page flex flex-col sm:flex-row items-center justify-between gap-6 text-center sm:text-left">
            ...
            <a href="{{ 'https://wa.me/' . config('uprise.whatsapp.number') . '?text=' . urlencode(config('uprise.whatsapp.default_message')) }}"
                ...
                class="btn-shimmer shrink-0 inline-flex items-center gap-2 bg-white text-ink font-semibold text-sm px-6 py-3 rounded-lg
                      hover:bg-ink hover:text-white transition-colors duration-150 tracking-wide">
                Book via WhatsApp
            </a>
        </div>
    </section>
