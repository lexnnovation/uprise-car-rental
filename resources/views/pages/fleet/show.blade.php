                    ...
                    <div>
                        ...
                        <dl class="grid grid-cols-2 sm:grid-cols-3 gap-4">
                            ...
                            <div class="bg-white rounded-md p-4 shadow-card">
                                ...
                                <dd class="font-display font-bold text-ink text-2xl">{{ $vehicle->luggage_count }} bags
                                </dd>
                            </div>
                            <div class="bg-white rounded-md p-4 shadow-card">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-2 sm:grid-cols-3 gap-3">
                                @foreach ($vehicle->getMedia('gallery') as $image)
                                    <img src="{{ $image->getUrl('card') }}" alt="{{ $vehicle->name }}"
                                        class="w-full aspect-video object-cover rounded-md" loading="lazy">
                                @endforeach
                            </div>
                        </div>
                    @endif
