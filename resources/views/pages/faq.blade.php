                ...
                @else
                    @foreach ($grouped as $category => $items)
                        <div class="mb-12 last:mb-0" data-reveal>
                            ...
                            @if ($category)
                                <h2
                                    class="font-display font-bold text-ink text-lg mb-6 pb-3 border-b border-mist flex items-center gap-3">
                                ...
                                @foreach ($items as $faq)
                                    <div x-data="{ open: false }"
                                        ...
                                        <button @click="open = !open"
                                            ...
                                            <span class="shrink-0 mt-0.5">
                                                <svg class="w-4 h-4 text-stone transition-transform duration-200"
                                                    :class="open ? 'rotate-180 text-accent' : ''" fill="none"
                                        ...
                                        <div x-show="open" x-transition:enter="transition ease-out duration-200"
                                            ...
                                            <div
                                                class="pt-4 text-stone text-sm leading-relaxed prose prose-sm prose-stone max-w-none">
                                                {!! nl2br(e($faq->answer)) !!}
                                            </div>
                                        </div>
