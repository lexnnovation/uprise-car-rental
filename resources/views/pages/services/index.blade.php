...
@php
    ...
    $metaDescription = 'Airport transfers, executive chauffeur, safari tours, Cape Coast day trips, corporate travel and cross-border hire across Ghana and West Africa — all with a professional driver.';
@endphp
    ...
    <section class="bg-ink-deep border-b border-charcoal-soft">
        <div class="container-page py-14 lg:py-20">
            ...
            <p class="text-stone-soft text-base max-w-xl leading-relaxed">
                ...
                No self-drive options. Just reliable, comfortable travel across West Africa.
            </p>
        </div>
    </section>
            ...
            @else
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    @foreach ($services as $i => $service)
                        <article class="group relative bg-white rounded-md overflow-hidden shadow-card
                            ...
                            <div class="flex flex-col p-6 flex-1">
                                ...
                                <div class="flex items-start gap-4 mb-4">
                                    <span class="font-display font-bold text-3xl text-mist leading-none shrink-0
                                                 group-hover:text-accent transition-colors duration-300 mt-0.5">
                                        {{ str_pad($loop->iteration, 2, '0', STR_PAD_LEFT) }}
                                    </span>
                                    <h2 class="font-display font-bold text-ink text-xl leading-snug
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    @php
                                        $url = 'https://wa.me/' . config('uprise.whatsapp.number') .
                                            '?text=' . urlencode('Hi Uprise Travel, I\'d like to enquire about your ' . $service->name . ' service.');
                                    @endphp
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                <div>
                    ...
                    <h2 class="font-display font-bold text-white text-display-sm tracking-tight mb-4">
                        Ghana and across West Africa.
                    </h2>
                    <p class="text-stone-soft text-sm leading-relaxed max-w-md">
                        Based in Accra, we operate in Ghana, Togo, Benin, Senegal and The Gambia.
                        Our drivers know the roads, borders, and logistics — so you don't have to.
                    </p>
                </div>
                <div class="grid grid-cols-2 sm:grid-cols-3 gap-3">
                    @foreach (['Ghana', 'Togo', 'Benin', 'Senegal', 'The Gambia', 'Cross-Border'] as $country)
    ...
    <section class="bg-accent py-12">
        <div class="container-page flex flex-col sm:flex-row items-center justify-between gap-6 text-center sm:text-left">
            ...
            <a href="{{ 'https://wa.me/' . config('uprise.whatsapp.number') . '?text=' . urlencode(config('uprise.whatsapp.default_message')) }}"
               ...
               class="shrink-0 inline-flex items-center gap-2 bg-white text-accent font-semibold text-sm
                      px-6 py-3 rounded-sm hover:bg-bone transition-colors duration-150 tracking-wide">
