...
@php
    ...
    $metaDescription = 'Uprise Travel is West Africa\'s premier chauffeur and car rental service, operating in Ghana, Togo, Benin, Senegal and The Gambia with professional drivers and reliable vehicles.';
@endphp
...
@section('content')
        ...
        <div class="container-page">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                ...
                <div class="grid grid-cols-2 gap-4">
                    @foreach ([
                        ['num' => '5',        'label' => 'Countries covered',          'sub' => 'Ghana · Togo · Benin · Senegal · Gambia'],
                        ['num' => '100%',     'label' => 'Driver-included bookings',   'sub' => 'No self-drive — ever'],
                        ['num' => '24 / 7',   'label' => 'WhatsApp availability',      'sub' => 'Reach us any time'],
                        ['num' => '10+',      'label' => 'Years in West Africa travel', 'sub' => 'Experience you can rely on'],
                    ] as $stat)
    ...
    {{-- COVERAGE --}}
    <section class="bg-charcoal border-y border-charcoal-soft py-14 lg:py-20">
        <div class="container-page">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 max-w-4xl mx-auto">
                @foreach ([
                    ['country' => 'Ghana',       'cities' => 'Accra · Kumasi · Cape Coast · Tamale · Takoradi'],
                    ['country' => 'Togo',        'cities' => 'Lomé · Kpalimé · Atakpamé'],
                    ['country' => 'Benin',       'cities' => 'Cotonou · Porto-Novo · Abomey'],
                    ['country' => 'Senegal',     'cities' => 'Dakar · Saint-Louis · Ziguinchor'],
                    ['country' => 'The Gambia',  'cities' => 'Banjul · Serrekunda · Bakau'],
                    ['country' => 'Cross-Border','cities' => 'Multi-country itineraries on request'],
                ] as $loc)
                ...
                @foreach ([
                    ...
                    <div class="bg-white rounded-md p-6 shadow-card">
                        <div class="w-10 h-10 rounded-full bg-ink flex items-center justify-center mb-4 shrink-0">
                            <svg class="w-4.5 h-4.5 text-accent" fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24">
