    ...
    */
    'contact' => [
        ...
        'locations' => [
            'accra' => [
                'label' => 'Accra',
                'street' => 'Buade Last Stop, Botchway Street, Nungua',
                'city' => 'Accra',
            ...
            'tamale' => [
                'label' => 'Tamale',
                'street' => 'Jiso Plaza, Jisonayili Road',
                'city' => 'Tamale',
        ...
        'hours' => env('UPRISE_HOURS', 'Monday–Sunday, 24 hours'),
        'hours_us' => env('UPRISE_HOURS_US', 'Monday–Sunday, 24 hours'),
